...
<CORSConfiguration><CORSRule><AllowedOrigin>http://127.0.0.1:9091</AllowedOrigin><AllowedOrigin>http://localhost:9091</AllowedOrigin><AllowedOrigin>http://101.126.41.246</AllowedOrigin><AllowedOrigin>http://rerun-web</AllowedOrigin><AllowedOrigin>https://*.apigateway-cn-beijing.volceapi.com</AllowedOrigin><AllowedMethod>GET</AllowedMethod><AllowedMethod>HEAD</AllowedMethod><AllowedMethod>PUT</AllowedMethod><AllowedMethod>DELETE</AllowedMethod><AllowedHeader>*</AllowedHeader><ExposeHeader>ETag</ExposeHeader><ExposeHeader>Content-Range</ExposeHeader><ExposeHeader>Content-Length</ExposeHeader><ExposeHeader>x-amz-meta-rerun-fingerprint</ExposeHeader><ExposeHeader>x-amz-meta-rerun-source-url</ExposeHeader><MaxAgeSeconds>3600</MaxAgeSeconds></CORSRule></CORSConfiguration>
EOF
