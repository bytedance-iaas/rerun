...
fn column_descriptor_ui(ui: &mut egui::Ui, column: &ColumnDescriptorRef<'_>, column_field: &Field) {
    ...
    match *column {
        ...
        ColumnDescriptorRef::Time(desc) => {
            ...
            header_property_ui(ui, "类型", "index");
            header_property_ui(ui, "时间轴", timeline.name());
            header_property_ui(ui, "是否排序", sorted_text(*is_sorted));
        ...
        ColumnDescriptorRef::Component(desc) => {
            ...
            header_property_ui(ui, "列类型", "Component");
            header_property_ui(ui, "实体路径", entity_path.ui_string());
            ...
            header_property_ui(ui, "组件", component);
            header_property_ui(
                ui,
                "组件类型",
